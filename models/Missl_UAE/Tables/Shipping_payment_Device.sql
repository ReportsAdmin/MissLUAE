select safe_divide(PaymentPage,Transaction) payment_trnx ,D_ga_deviceCategory,StartDate,'MissLUAE' Halo_Country from(
...
from `noted-computing-279322.halo_1_1_UAE.fGABaseShoppingStages` )
