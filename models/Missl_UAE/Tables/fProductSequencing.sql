select *,row_number() over (partition by category_L1 order by RevPerImpression desc) DesiredPositioning,'MissLUAE' Halo_Country
from(
...
`noted-computing-279322.halo_1_1_UAE.refProducts` b
